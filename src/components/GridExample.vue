...
<body>
  ...
  <main class="testimonial-grid">
    ...
    <article class="testimonial flow bg-secondary-400 text-neutral-100">
      <div class="flex">
        <div>
          <img src="https://picsum.photos/200/304" alt="Jonathan Walters">
        </div>
        <div>
    ...
    <article class="testimonial flow bg-neutral-100 text-secondary-400">
      <div class="flex">
        <div>
          <img src="https://picsum.photos/200/303" alt="Jeanette Harmon">
        </div>
        <div>
    ...
    <article class="testimonial grid-col-span-2 flow bg-secondary-500 text-neutral-100">
      <div class="flex">
        <div>
          <img class="border-primary-400" src="https://picsum.photos/200/302" alt="Patrick Abrams">
        </div>
        <div>
    ...
    <article class="testimonial flow bg-neutral-100 text-secondary-400">
      <div class="flex">
        <div>
          <img src="https://picsum.photos/200/301" alt="Kira Whittle">
        </div>
        <div>
